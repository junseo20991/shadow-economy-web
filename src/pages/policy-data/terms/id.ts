export default {
  ...
  "intro": [
    "Ketentuan Layanan ini (\"Ketentuan\") mengatur penggunaan Anda atas aplikasi seluler Shadow Economy, situs web shadoweconomyapp.com, dan layanan terkait (secara kolektif disebut \"Layanan\").",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Jika Anda masih di bawah umur atau di bawah usia yang memerlukan persetujuan orang tua atau wali sah berdasarkan hukum tempat tinggal Anda, Anda menggunakan Layanan dengan persetujuan orang tua atau wali sah.",
            "Anda mematuhi hukum yang berlaku, Ketentuan ini, kebijakan toko aplikasi, dan pemberitahuan dalam Layanan."
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Permainan tamu",
            "Pembuatan dan masuk akun opsional",
            "Penyimpanan cloud dan sinkronisasi kemajuan lintas perangkat saat masuk",
            "Pembelian kredit laporan dalam aplikasi",
            "Membuka kunci laporan pendidikan yang dipersonalisasi untuk gameplay yang telah selesai",
            "Akses berbasis akun ke laporan tersimpan",
            "Pengenalan permainan, informasi harga, dukungan pelanggan, dan pemberitahuan hukum melalui situs web"
          ]
        },
        {
          "type": "p",
        ...
        },
        {
          ...
          "items": [
            ...
            "Mengubah format laporan atau struktur konten",
            "Mengubah server, database, metode otentikasi, atau metode verifikasi pembayaran",
            "Menghentikan dukungan untuk versi aplikasi yang lebih lama",
            "Membatasi ketersediaan Layanan di negara atau wilayah tertentu",
            "Perubahan darurat untuk keamanan, kepatuhan hukum, atau kepatuhan kebijakan platform"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Jual, transfer, sewa, gadaikan, atau bagikan akun",
            "Perdagangkan akun, kredit laporan, laporan, atau data game dengan uang tunai atau nilai yang setara dengan uang tunai",
            "Lewati langkah-langkah keamanan akun",
            "Memberikan akses akun kepada orang yang terkena sanksi atau orang yang dilarang menggunakan Layanan"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Reset atau ubah perangkat",
            "Pembaruan sistem operasi atau aplikasi",
            "Pembatasan akses penyimpanan",
            "Penghapusan cache atau Penyimpanan lokal",
            "Kesalahan teknis"
          ]
        },
        {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Kredit laporan tidak memiliki nilai tunai.",
            "Kredit laporan tidak boleh ditransfer, dijual, ditukar, dijaminkan, atau ditukarkan dengan uang tunai.",
            "Kredit laporan hanya dapat digunakan dengan cara yang diizinkan secara tegas oleh Operator.",
            "Satu kredit laporan membuka satu laporan untuk satu game selesai yang mencapai status akhir yang didukung di aplikasi.",
            "Menggunakan kredit laporan untuk membuka kunci laporan akan menghabiskan kredit tersebut.",
            "Kredit yang tidak terpakai dapat disimpan selama akun tetap aktif."
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Setelah pembelian selesai, kredit laporan diberikan ke akun yang digunakan untuk pembayaran.",
            "Hibah dapat ditunda, dibatalkan, atau diperbaiki jika terjadi kegagalan verifikasi pembayaran, kesalahan jaringan, kegagalan platform, pengembalian dana, pembatalan, atau transaksi penipuan yang dikonfirmasi.",
            "Anda harus memverifikasi produk, harga, kuantitas, akun, platform, dan ketentuan pembayaran sebelum membeli.",
            "Anda harus mengelola akun platform, autentikasi pembayaran, dan akses perangkat Anda dengan aman."
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Pengabaian pembayaran, penyalahgunaan pengembalian dana, duplikat hibah, atau kegagalan verifikasi",
            "Kegagalan server, kesalahan database, atau konflik sinkronisasi",
            "Kemajuan game yang tidak normal atau tidak adil atau membahayakan integritas Layanan",
            "Jika diwajibkan oleh hukum, kebijakan platform, atau untuk alasan keamanan",
            "Apabila diperlukan untuk melindungi pengguna atau menjaga stabilitas Layanan"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Meniru identitas orang lain atau menggunakan identitas palsu",
            "Akses tidak sah ke Layanan, server, jaringan, atau database",
            "Mengganggu, membebani, menyerang, mengeksploitasi kerentanan, atau mengabaikan keamanan Layanan",
            "Merekayasa balik, mendekompilasi, membongkar, mengekstrak kode sumber, atau mengutak-atik, kecuali sejauh diizinkan oleh hukum",
            "Akses Layanan atau tingkatkan gameplay menggunakan bot, skrip, makro, alat otomatisasi, atau cara tidak normal",
            "Pengikisan, perayapan, penambangan data, atau pengumpulan massal yang tidak sah",
            "Ekstrak konten, data game, atau format laporan secara sistematis untuk mengembangkan produk, kumpulan data, atau sistem otomatis yang bersaing",
            "Lewati pembayaran, laporkan kredit, aturan permainan, batasan teknis, atau langkah-langkah keamanan",
            "Memanfaatkan bug, kerentanan, kesalahan, atau perilaku yang tidak diinginkan",
            "Menjual, mentransfer, menyewakan, menukar, atau memonetisasi kredit laporan, akun, data game, atau item digital",
            "Mengunggah, mengirimkan, atau mengeksekusi malware, spyware, serangan otomatis, atau kode berbahaya",
            "Menipu Operator, platform, penyedia pembayaran, atau pengguna lain",
            "Melanggar Hukum yang Berlaku, kebijakan platform, atau Ketentuan ini"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Akses ke akun, informasi pribadi, atau data game orang lain",
            "Melewati sistem pembayaran, pemberian kredit, atau sistem otentikasi",
            "Mengungkapkan informasi kerentanan kepada publik dengan cara yang meningkatkan risiko eksploitasi",
            "Melakukan pengujian massal otomatis atau pengujian penetrasi tanpa izin jelas dari Operator"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Desain permainan, aturan, struktur keseimbangan, dan metode simulasi ekonomi",
            "Teks, gambar, grafik, UI, logo, merek dagang, dan elemen merek",
            "Format laporan, templat laporan, metode presentasi, dan konten pendidikan",
            "Dokumentasi, materi dukungan pelanggan, dan konten lainnya"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Kepatuhan terhadap hukum, otoritas pengatur, perintah pengadilan, atau kebijakan platform",
            "Penyalahgunaan, risiko keamanan, atau penyalahgunaan Layanan",
            "Kebutuhan bisnis, teknis, atau operasional",
            "Force majeure atau keadaan di luar kendali"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Penipuan pembayaran, penyalahgunaan pengembalian dana, atau kegagalan verifikasi pembelian",
            "Risiko keamanan atau akses tidak sah",
            "Membahayakan integritas Layanan",
            "Risiko kerugian bagi orang lain atau Operator",
            "Kewajiban atau permintaan hukum dari otoritas pengatur atau pengadilan",
            "Pengakhiran atau penghentian layanan di wilayah tertentu"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Data game, kredit laporan, laporan tersimpan, atau data lokal akan selalu disimpan",
            "Informasi dalam Layanan atau laporan tersebut lengkap, akurat, terkini, atau sesuai untuk tujuan tertentu",
            "Bahwa Layanan akan memenuhi harapan, tujuan pendidikan, atau hasil spesifik Anda",
            "Bahwa Layanan sepenuhnya bebas dari virus, kerentanan, kesalahan, atau elemen berbahaya",
            "Layanan pihak ketiga, toko aplikasi, sistem pembayaran, atau penyedia autentikasi akan selalu tersedia"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Hilangnya akses ke item digital, data game, atau laporan",
            "Kerusakan karena kegagalan layanan pihak ketiga"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Pembayaran palsu, penyalahgunaan pengembalian dana, pembagian akun, atau pelanggaran keamanan Anda",
            "Perselisihan pihak ketiga yang timbul dari materi atau informasi yang Anda kirimkan"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Anda tidak menggunakan Layanan untuk orang yang terkena sanksi atau tujuan terlarang.",
            "Anda tidak mentransfer, mengekspor, atau mengekspor kembali Layanan yang melanggar undang-undang kontrol ekspor yang berlaku."
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Konten, materi, tautan, atau lokasi diklaim melanggar",
            "Pernyataan bahwa Anda berwenang untuk membuat laporan",
            "Pernyataan bahwa laporan tersebut akurat"
          ]
        },
        {
          "type": "p",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Jika aplikasi tidak memenuhi jaminan apa pun yang berlaku, Anda dapat memberi tahu Apple, dan jika berlaku, Apple dapat mengembalikan uang sebesar harga pembelian aplikasi.",
            "Sejauh diizinkan oleh undang-undang, Apple tidak memiliki kewajiban jaminan lainnya terkait aplikasi tersebut.",
            "Apple tidak bertanggung jawab atas klaim, klaim tanggung jawab produk, klaim perlindungan konsumen, klaim privasi, atau klaim kepatuhan terhadap peraturan terkait dengan aplikasi atau penggunaan aplikasi oleh Anda.",
            "Tanggung jawab investigasi, pembelaan, penyelesaian, dan ganti rugi atas klaim bahwa aplikasi atau penggunaan aplikasi oleh Anda melanggar hak kekayaan intelektual pihak ketiga terletak pada Operator, bukan Apple.",
            "Apple dan anak perusahaan Apple adalah penerima manfaat pihak ketiga dari Ketentuan ini sehubungan dengan aplikasi iOS, dan berdasarkan persetujuan Anda terhadap Ketentuan ini, Apple berhak untuk menegakkan Ketentuan ini terhadap Anda sebagai penerima manfaat pihak ketiga.",
            "Anda menyatakan bahwa Anda tidak tinggal di negara yang terkena embargo Pemerintah A.S. dan bahwa Anda tidak tercantum dalam daftar pihak yang dilarang atau dibatasi oleh Pemerintah A.S.",
            "Pertanyaan, keluhan, atau klaim terkait aplikasi dapat dikirimkan ke contact@shadoweconomyapp.com."
          ]
        },
        {
          "type": "h3",
        ...
        },
        {
          ...
          "items": [
            ...
            "Tanggung jawab atas pemeliharaan, dukungan, konten, dan fitur aplikasi terletak pada Operator sesuai dengan Hukum yang Berlaku dan Ketentuan ini.",
            "Google tidak berkewajiban menyelesaikan klaim, jaminan, pemeliharaan, dukungan, atau masalah kekayaan intelektual terkait aplikasi atas nama Operator.",
            "Anda harus mematuhi kebijakan terkait Google Play dan Android."
          ]
        }
      ]
    },
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Postingan situs web",
            "Email ke alamat email akun Anda",
            "Pemberitahuan push atau pesan sistem, dimana Layanan menyediakan fitur tersebut",
            "Sarana elektronik lain yang wajar"
          ]
        },
        {
          "type": "p",
