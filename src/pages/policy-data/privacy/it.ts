export default {
  ...
  "intro": [
    ...
    "Richieste relative alla privacy: contact@shadoweconomyapp.com"
  ],
  "sections": [
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Attività, passività, entrate, spese e cronologia dei turni",
            "Scelte di gioco, risultati degli eventi e stati finali",
            "Stati di gioco salvati e dati di sincronizzazione cloud"
          ]
        },
        {
          "type": "P",
        ...
        },
        {
          "type": "ul",
          "items": [
            "Segnala il saldo del credito",
            "Se i report sono sbloccati",
            "Dati di gioco completati utilizzati per generare report",
            "Segnala il contenuto e i relativi metadati che scegli di salvare"
          ]
        },
        {
          "type": "P",
        ...
        },
        {
          ...
          "items": [
            ...
            "Preferenze predefinite relative alla visualizzazione selezionate nell'app o nel sito web",
            "Impostazioni locali memorizzate sul dispositivo o sul browser"
          ]
        },
        {
          "type": "h3",
        ...
        },
        {
          "type": "ul",
          "items": [
            "Identificatori di transazione App Store",
            "Tipologia di prodotto acquistato",
            "Numero di crediti di report concessi",
        ...
        },
        {
          ...
          "items": [
            ...
            "Informazioni tecniche limitate relative al dispositivo e al browser",
            "Informazioni sulla sessione di autenticazione",
            "Registri degli errori",
            "Registri di sicurezza",
            "Registri del server",
            "Percorso della richiesta e stato di elaborazione della richiesta"
          ]
        },
        {
          "type": "P",
        ...
        },
        {
          ...
          "items": [
            ...
            "Impostazioni di ricezione delle notifiche",
            "Stato di consegna della notifica",
            "Log tecnici limitati relativi alle notifiche"
          ]
        },
        {
          "type": "P",
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          "type": "ul",
          "items": [
            "Informazioni inserite o inviate direttamente",
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "h3",
          "text": "5.1 Fornitura di servizi e gestione dell'account"
        },
        {
          "type": "ul",
          "items": [
            "Creazione dell'account, accesso e autenticazione",
            "Manutenzione della sessione",
            "Sincronizzazione dei progressi di gioco su dispositivi con lo stesso account",
            "Cancellazione dell'account e gestione delle richieste relative all'account",
        ...
        {
          "type": "h3",
          "text": "5.2 Funzionalità del gioco"
        },
        {
          "type": "ul",
          "items": [
            "Salvataggio dei progressi del gioco",
            "Ripristino dello stato del gioco",
            "Elaborazione dei risultati, delle scelte e degli eventi del gioco",
            "Fornire funzionalità in-app",
            "Mantenimento delle impostazioni della lingua e dell'ambiente predefinito",
            "Mantenere l'esperienza di servizio"
          ]
        },
        {
          "type": "h3",
          "text": "5.3 Acquisti in-app e segnalazione dell'adempimento del credito"
        },
        {
          "type": "ul",
          "items": [
            "Verifica dell'acquisto",
            "Concessione di crediti di report",
            "Conferma della cronologia degli acquisti",
            "Gestire rimborsi, cancellazioni, errori o sovvenzioni duplicate",
            "Prevenire transazioni fraudolente e abusi nei pagamenti",
            "Assistenza clienti e gestione delle controversie"
          ]
        },
        {
          "type": "P",
        ...
        {
          "type": "h3",
          "text": "5.4 Report didattici personalizzati"
        },
        {
          "type": "ul",
          "items": [
            "Generazione di report educativi personalizzati basati sui dati di gioco completati",
            "Sblocco e salvataggio dei report",
            "Supporta l'accesso cross-device ai report salvati",
            "Fornire assistenza clienti relativa ai report"
          ]
        },
        {
          "type": "P",
        ...
        {
          "type": "h3",
          "text": "5.5 Sicurezza, integrità e prevenzione degli abusi"
        },
        {
          "type": "ul",
          "items": [
            "Rilevamento accessi anomali",
            "Prevenire l'interruzione del servizio, l'automazione, lo scraping, gli imbrogli o l'elusione dei pagamenti",
            "Mantenimento dell'autenticazione e della sicurezza dell'account",
            "Protezione di server, database e infrastruttura di servizi",
            "Indagare e rispondere agli incidenti di sicurezza",
            "Rispondere a crediti ottenuti in modo improprio, pagamenti fraudolenti o usi anomali"
          ]
        },
        {
          "type": "h3",
          "text": "5.6 Manutenzione e miglioramento del servizio"
        },
        {
          "type": "ul",
          "items": [
            "Diagnosi degli errori e risposta agli incidenti",
            "Verifica delle prestazioni e della stabilità del server",
            "Miglioramento della funzionalità del servizio",
            "Gestione della compatibilità delle versioni dell'app",
            "Riflettendo le richieste e i feedback degli utenti",
            "Migliorare la qualità e la sicurezza del servizio"
          ]
        },
        {
          "type": "P",
        ...
        {
          "type": "h3",
          "text": "5.7 Conformità legale e tutela dei diritti"
        },
        {
          "type": "ul",
          "items": [
            "Adempiere agli obblighi di legge",
            "Adempiere agli obblighi fiscali, contabili, di tutela dei consumatori e di commercio elettronico",
            "Rispondere a richieste legittime da parte delle forze dell’ordine, dei tribunali o delle autorità di vigilanza",
            "Proteggere i diritti, la proprietà o la sicurezza degli utenti, dell'Operatore o del pubblico",
            "Stabilire, esercitare o difendere rivendicazioni legali",
            "Prevenire e rispondere alle controversie"
          ]
        }
      ]
    },
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Salvataggio e sincronizzazione dei progressi del gioco",
            "Concessione di crediti di report",
            "Fornire report didattici personalizzati",
            "Evasione degli acquisti in-app",
            "Fornire assistenza clienti"
          ]
        },
        {
        ...
        },
        {
          "type": "ul",
          "items": [
            "Mantenimento della sicurezza del servizio",
            "Prevenire transazioni fraudolente e abusi",
            "Diagnosi degli errori e miglioramento della stabilità del servizio",
            "Stabilire, esercitare o difendere rivendicazioni legali",
            "Tutela dell'integrità del servizio",
            "Rispondere alle domande degli utenti",
            "Miglioramento limitato del servizio"
          ]
        },
        {
          "type": "h3",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Fornire pubblicità personalizzata di terze parti",
            "Prendi esclusivamente decisioni automatizzate che producono effetti legali o effetti similmente significativi che ti riguardano, come punteggio di credito, occupazione, assicurazione, prestito, alloggio o status giuridico",
            "Fornire dati per l'addestramento di modelli di intelligenza artificiale generativa di terze parti"
          ]
        },
        {
          "type": "P",
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          "type": "ul",
          "items": [
            "Ove necessario, per rispondere a richieste legittime ai sensi della legge applicabile, di ordinanze di tribunali, forze dell'ordine o autorità di vigilanza",
            "Ove necessario, per indagare o rispondere a violazioni dei termini di servizio, frode, minacce alla sicurezza o condotta illecita",
            "Ove necessario per proteggere i diritti, la proprietà o la sicurezza degli utenti, dell'Operatore o del pubblico",
            "Ove necessario per stabilire, esercitare o difendere rivendicazioni legali",
            "Ove necessario, per rispondere a pagamenti fraudolenti, abusi di rimborsi, compromissione dell'account o compromissione dell'integrità del servizio"
          ]
        },
        {
          "type": "h3",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Singapore",
            "Stati Uniti",
            "Altri paesi in cui i fornitori di servizi gestiscono server, supporto, sicurezza o infrastruttura"
          ]
        },
        {
          "type": "P",
        ...
        },
        {
          "type": "ul",
          "items": [
            "Clausole contrattuali tipo (SCC) della Commissione Europea",
            "Addendum sul trasferimento internazionale dei dati nel Regno Unito o garanzie equivalenti",
            "Trasferimenti verso Paesi con decisione di adeguatezza",
            "Altre garanzie adeguate riconosciute dalla legge applicabile"
          ]
        }
      ]
    },
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          "type": "ul",
          "items": [
            "Crittografia TLS 1.2 o successiva in transito",
            "Crittografia standard del settore per l'archiviazione nel cloud",
            "Autenticazione Supabase e gestione delle sessioni",
            "Nessuna memorizzazione delle password di accesso social",
            "Accesso limitato ai sistemi operativi",
            "Accesso limitato all'ambito minimo necessario per il funzionamento del servizio",
            "Revisione regolare delle pratiche di sicurezza",
            "Evitare la memorizzazione diretta delle informazioni di pagamento",
            "Utilizzo delle funzionalità di sicurezza del fornitore di servizi",
            "Accesso limitato ai registri e alle informazioni di autenticazione",
            "Riduzione al minimo delle autorizzazioni di accesso all'account e al database"
          ]
        },
        {
          "type": "P",
    ...
    {
      "title": "12. Cookie, archiviazione locale e tecnologie simili",
      "blocks": [
        {
          "type": "h3",
          "text": "12.1 Sito web"
        ...
        },
        {
          "type": "ul",
          "items": [
            "Salvataggio della selezione della lingua",
            "Mantenimento delle impostazioni di visualizzazione predefinite",
            "Fornire funzionalità del sito web",
            "Mantenere la sicurezza e la stabilità tecnica",
            "Mantenimento dello stato della sessione o dell'autenticazione"
          ]
        },
        {
          "type": "P",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Diritto a non essere discriminato per l’esercizio dei diritti"
          ]
        },
        {
          "type": "P",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Diritto di revocare il consenso laddove il trattamento sia basato sul consenso",
        ...
        },
        {
          "type": "ul",
          "items": [
            "Diritto di conoscere le categorie di dati personali raccolti dall'Operatore, le fonti, le finalità e i destinatari della condivisione",
            "Diritto di ricevere una copia delle informazioni personali",
            "Diritto di richiedere la cancellazione dei dati personali",
            "Diritto di richiedere la correzione di dati personali inesatti",
            "Diritto di opporsi alla vendita o alla condivisione di informazioni personali per la pubblicità comportamentale intercontestuale",
            "Diritto di limitare l'uso e la divulgazione di informazioni personali sensibili",
            "Diritto a non essere discriminato per l’esercizio dei diritti",
            "Diritto di effettuare richieste tramite un agente autorizzato ragionevolmente verificato"
          ]
        },
        {
          "type": "P",
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          "type": "ul",
          "items": [
            "Nuova Zelanda: Ufficio del Garante della Privacy",
            "SEE: autorità di controllo della protezione dei dati nel tuo paese di residenza",
            "Regno Unito: Ufficio del Commissario per l'informazione",
            "Australia: Ufficio del Commissario australiano per l'informazione",
            "California: Agenzia per la protezione della privacy della California",
            "Canada: Ufficio del Commissario per la privacy del Canada o autorità provinciale competente",
            "Brasile: Autoridade Nacional de Proteção de Dados",
            "Repubblica di Corea: Commissione per la protezione dei dati personali o autorità competente"
          ]
        },
        {
          "type": "P",
